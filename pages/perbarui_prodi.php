...
session_start();
 ...
 $getData = $con->query("SELECT * FROM prodi WHERE ID_PRODI = ".$id_prodi);
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST" action="update-prodi.php" enctype="multipart/form-data">                                
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="nama_prodi" required value="<?=$getData["NAMA_PRODI"]?>">
                                        <label class="form-label">Nama Program Studi</label>
                                    </div>
                                </div>                                                                                                         
                                <button class="btn btn-primary waves-effect" type="submit" name="simpan">Simpan</button>
                                <button class="btn btn-primary waves-effect" type="submit" name="batal" href="view_prodi.php">Batal</button>
                            </form>
                        </div>
                    </div>
                </div>
