<?php
 ...
 $getData = $con->query("SELECT * FROM trans_perlengkapan WHERE ID_TRANS = ".$id_trans);
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Perbarui Data Pengambilan Perlengkapan</h2>                            
                        </div>
                        <div class="body">
                            <form id="form_validation" method="POST" action="update-trans-perlengkapan.php" ">
                                <input type="hidden" name="id_trans" id="id_trans" value="<?=$getData["ID_TRANS"]?>"/>                        
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="id_paket" required value="<?=$getData["ID_PAKET"]?>">
                                        <label class="form-label">Id Paket</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="kelas" required value="<?=$getData["KELAS"]?>">
                                        <label class="form-label">Kelas</label>
                                    </div>
                                </div>                                                                                                         
                                <button class="btn btn-primary waves-effect" type="submit" name="simpan">Simpan</button>
                                <button class="btn btn-primary waves-effect" type="submit" name="batal" href="view_trans_perlengkapan.php">Batal</button>
                            </form>
                        </div>
                    </div>
                </div>
