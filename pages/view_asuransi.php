                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <?php $getAsuransi = $con->query("SELECT * FROM asuransi");
                                        while ($fetchAsuransi = $getAsuransi->fetch_assoc()){ ?>
                                        <tr>
                                            <td><?=$fetchAsuransi['NO_ASURANSI']?></td>
                                            <td><?=$fetchAsuransi['NIT']?></td>
                                            <td><?=$fetchAsuransi['GAMBAR']?></td>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Tabel Data Taruna Belum Mendapat Asuransi
                            </h2>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <?php $getAsuransi = $con->query("SELECT * FROM taruna WHERE NIT NOT IN (SELECT NIT FROM asuransi)");
                                        while ($fetchAsuransi = $getAsuransi->fetch_assoc()){ ?>
                                        <tr>
                                            <td><?=$fetchAsuransi['NIT']?></td>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Tabel Data Taruna Sudah Mendapat Asuransi
                            </h2>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <?php $getAsuransi = $con->query("SELECT * FROM taruna WHERE NIT IN (SELECT NIT FROM asuransi)");
                                        while ($fetchAsuransi = $getAsuransi->fetch_assoc()){ ?>
                                        <tr>
                                            <td><?=$fetchAsuransi['NIT']?></td>
                                            <td><?=$fetchAsuransi['NAMA']?></td>
