                ...
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="tambah_trans_perlengkapan.php">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <?php $getTaruna = $con->query("SELECT * FROM taruna");
                                        while ($fetchTaruna = $getTaruna->fetch_assoc()){ ?>
                                        <tr>
                                            <td><?=$fetchTaruna['NIT']?></td>
                                            ...
                                            <td><a href="perbarui_taruna.php?nit=<?=$fetchTaruna["NIT"]?>">Ubah</a>
                                                ...
                                                <b> | </b>
                                                <a href="detail_taruna.php?nit=<?=$fetchTaruna["NIT"]?>">Detail</a>
                                            </td>
                                        </tr>
                                        <?php } ?>                                                                             
                                    </tbody>
