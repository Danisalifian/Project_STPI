        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Tambah Data Pengambilan Perlengkapan</h2>                            
                        </div>
                        <div class="body">
                            <form id="form_validation" method="POST" action="create-trans-perlengkapan.php">                                
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        ...
                                        <?php
                                            $getPerlengkapan = $con->query("SELECT * FROM perlengkapan");
                                        ?> 
                                        <select class="form-control show-tick" name="id_paket">
                                            <option value="null">-- Pilih Paket Perlengkapan --</option>
                                            <?php while($fetchPerlengkapan=$getPerlengkapan->fetch_assoc()) {?>
                                            <option value="<?=$fetchPerlengkapan['ID_PAKET'] ?>"><?=$fetchPerlengkapan['ID_PAKET'] ?></option>
                                            <?php } ?>
                                        </select>
