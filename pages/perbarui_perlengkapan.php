        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Perbarui Data Perlengkapan</h2>                            
                        </div>
                        <div class="body">
                            <form id="form_validation" method="POST" action="update-perlengkapan.php" ">                                
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="id_paket" maxlength="10" minlength="3" required value="<?=$getData["ID_PAKET"]?>">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="detail" required value="<?=$getData["DETAIL"]?>">
                                ...
                                <button class="btn btn-primary waves-effect" type="submit" name="batal" href="view_perlengkapan.php">Batal</button>
                            </form>
                        </div>
                    </div>
                </div>
