                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <?php $getPerlengkapan = $con->query("SELECT * FROM perlengkapan");
                                        while ($fetchPerlengkapan = $getPerlengkapan->fetch_assoc()){ ?>
                                        <tr>
                                            <td><?=$fetchPerlengkapan['ID_PAKET']?></td>
                                            <td><?=$fetchPerlengkapan['DETAIL']?></td>
                                            <td><a href="perbarui_perlengkapan.php?id_paket=<?=$fetchPerlengkapan["ID_PAKET"]?>">Ubah</a>
                                                <b> | </b>
                                                <a href="hapus_perlengkapan.php?id_paket=<?=$fetchPerlengkapan["ID_PAKET"]?>">Hapus</a>
                                            </td>
                                        </tr>
                                        <?php } ?>                                                                             
                                    </tbody>
