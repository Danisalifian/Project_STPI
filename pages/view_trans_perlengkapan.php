            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Tabel Data Pengambilan Perlengkapan
                            </h2>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <?php $getData = $con->query("SELECT * FROM trans_perlengkapan");
                                        while ($fetchData = $getData->fetch_assoc()){ ?>
                                        <tr>
                                            <td><?=$fetchData['ID_TRANS']?></td>
                                            <td><?=$fetchData['NIT']?></td>
                                            <td><?=$fetchData['ID_PAKET']?></td>
                                            <td><?=$fetchData['KELAS']?></td>
                                            <td><?=$fetchData['TGL']?></td>
                                            <td><a href="perbarui_trans_perlengkapan.php?id_trans=<?=$fetchData["ID_TRANS"]?>">Ubah</a>
                                                <b> | </b>
                                                <a href="hapus_trans_perlengkapan.php?id_trans=<?=$fetchData["ID_TRANS"]?>">Hapus</a>
                                            </td>
                                        </tr>
                                        <?php } ?>                                                                             
                                    </tbody>
