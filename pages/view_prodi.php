                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <?php $getProdi = $con->query("SELECT * FROM prodi");
                                        while ($fetchProdi = $getProdi->fetch_assoc()){ ?>
                                        <tr>
                                            <td><?=$fetchProdi['ID_PRODI']?></td>
                                            <td><?=$fetchProdi['NAMA_PRODI']?></td>
                                            <td><a href="perbarui_prodi.php?id_prodi=<?=$fetchProdi["ID_PRODI"]?>">Ubah</a>
                                                <b> | </b>
                                                <a href="hapus_prodi.php?id_prodi=<?=$fetchProdi["ID_PRODI"]?>">Hapus</a>
                                            </td>
                                        </tr>
                                        <?php } ?>                                                                             
                                    </tbody>
