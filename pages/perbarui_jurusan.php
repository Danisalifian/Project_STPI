<?php
 ...
 $getData = $con->query("SELECT * FROM jurusan WHERE ID_JURUSAN = ".$id_jurusan);
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Perbarui Data Jurusan</h2>                            
                        </div>
                        <div class="body">
                            <form id="form_validation" method="POST" action="update-jurusan.php" ">                                
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="id_jurusan" maxlength="10" minlength="3" required value="<?=$getData["ID_JURUSAN"]?>">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="nama_jurusan" required value="<?=$getData["NAMA_JURUSAN"]?>">
                                        <label class="form-label">Nama Jurusan</label>
                                    </div>
                                </div>                                                                                                         
                                <button class="btn btn-primary waves-effect" type="submit" name="simpan">Simpan</button>
                                <button class="btn btn-primary waves-effect" type="submit" name="batal" href="view_jurusan.php">Batal</button>
                            </form>
                        </div>
                    </div>
                </div>
